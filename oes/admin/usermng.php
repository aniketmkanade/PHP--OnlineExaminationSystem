...
<?php
        ...
        $result = executeQuery("select stdid,stdname,DECODE(stdpassword,'".$pass_enc."') as stdpass ,emailid,contactno,address,city,pincode from student where stdname='" . htmlspecialchars($_REQUEST['edit'], ENT_QUOTES) . "';");
