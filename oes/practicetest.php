                        ...
                        <table border="0" width="100%" class="ntab">
                            ...
                            <tr><td >1. <input type="radio" name="answer" value="DennisRitchie" <?php if ((strcmp($_SESSION['q2status'], "review") == 0 || strcmp($_SESSION['q2status'], "answered") == 0) && strcmp($_SESSION['q2stdans'], "DennisRitchie") == 0) {
                                ...
                                echo "checked";
                                    ...
                                    <tr>
                                        <th style="width:80%;">
                                            <input type="submit" name="viewsummary" value="View Summary" class="subbtn"/>
                                            <input type="submit" name="previous" value="Previous" class="subbtn"/>
                                            <input type="submit" name="summary" value="Summary" class="subbtn" />
                                        </th>
                                    </tr>
...
?>
                            <div class="tc">
                                ...
                                echo "checked";
                                    ...
                                    <tr>
                                        <th style="width:80%;">
                                            <input type="submit" name="next" value="Next" class="subbtn"/>
                                            <!--<input type="submit" name="fsum" value="Summary" class="subbtn" />-->
                                        </th>
                                    </tr>
