...
<script type="text/javascript" >
        <?php
                ...
                if(((int)$elapsed/60)<(int)$_REQUEST['duration'])
                {
					...
					TIME_FORMAT(TIMEDIFF(endtime,CURRENT_TIMESTAMP),'%i') as min,TIME_FORMAT(TIMEDIFF(endtime,CURRENT_TIMESTAMP),'%s') 
					as sec from studenttest where stdid=".$_REQUEST['stdid']." and testid=".$_REQUEST['testid'].";");
